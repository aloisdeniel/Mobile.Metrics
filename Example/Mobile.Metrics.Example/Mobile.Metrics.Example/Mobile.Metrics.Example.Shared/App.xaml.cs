...
using Mobile.Metrics.Example.Pages;
...
namespace Mobile.Metrics.Example
{
    /// <summary>
    ...
    public sealed partial class App : Application
    {
        ...
        public App()
        {
            ...
            SimpleIoc.Default.Register<IRestService, WebRestService>();
            SimpleIoc.Default.Register<IRepository<Customer>, CustomerRepository>();
            SimpleIoc.Default.Register<CustomerDataAccess>();
